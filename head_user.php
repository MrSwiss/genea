                            ...
                            <div class="grid_12">
                                <div class="grid_9 alpha">
                                    <ul>
                                        ...
                                        <li <?= ($active_menu == 2 ? 'class="current_page_item"' : '') ?>><a href="generator.php">สร้าง Code</a></li>
                                        <li <?= ($active_menu == 1 ? 'class="current_page_item"' : '') ?>><a href="user.php">ข้อมูลส่วนตัว</a></li>
