...
<div class="form-group" id="tab_i_idc_j">
    <div class="col-md-2">
        <div class="form-group">
            <div class="col-md-12">
                <select name="logic__" class="form-control" id="logic__">
    ...
    <div class="col-md-4" id="body_head">
        <div class="form-group">
            <div class="col-md-12">
                <select name="first__" class="form-control" id="first" onchange="getChild(this.id, 'first');">
    ...
    <div class="col-md-4">
        <div class="form-group">
            <div class="col-md-12">
                <select name="right__" class="form-control" id="last" onchange="getChild(this.id, 'last');">
                    <option value="0">--Select--</option>
                    <option value="1">ADX : Average Directional Movement Index</option>
                    <option value="2">ATR : Average True Range</option>
                    <option value="3">BB : Bollinger Band</option>
