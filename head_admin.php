                    ...
                    <div class="container_12">
                        <div class="grid_12">
                            <div class="grid_9 alpha">
                                <ul>
                                    <li <?= ($active_menu == 1 ? 'class="current_page_item"' : '') ?>><a href="admin.php">ข้อมูลส่วนตัว</a></li>
                                    <li <?= ($active_menu == 2 ? 'class="current_page_item"' : '') ?>><a href="manage_user.php">จัดการข้อมูลผู้ใช้</a></li>
                                    <li <?= ($active_menu == 3 ? 'class="current_page_item"' : '') ?>><a href="ad_logout.php">ออกจากระบบ</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
