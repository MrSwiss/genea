...
<html lang="en">
    ...
    <div class="container">
        <ul class="nav nav-tabs" role="tablist" style="background: whitesmoke;opacity: 0.9;">
            ...
            <li role="presentation" class=""><a href="#tab_6" aria-controls="activity" role="tab" data-toggle="tab">GENERATOR</a></li>
        </ul>
        <!-- Tab panes -->
        <form class="tab-content form-horizontal col-md-12" id="form_submit" method="post" action="form_submit.php" target="blank_" style="background: whitesmoke;opacity: 0.8;">
            <?php
            $hidden = 1;
            ?>
            ...
            <div role="tabpanel" style="padding-top: 10px;" class="tab-pane form-horizontal col-md-12" id="tab_5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-4">Percen Money Error : </label>
                    <div class="col-md-4">
            ...
            <div role="tabpanel" style="padding-top: 10px;" class="tab-pane form-horizontal col-md-12" id="tab_6">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" class="form-control" name="action_submit" id="action_submit" required="" value="" >
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group text-center">
                    <button class="btn btn-success" onclick="chkStoploss();" type="submit">ตกลง</button>
                </div>
            </div>
        </form>
    </div>
