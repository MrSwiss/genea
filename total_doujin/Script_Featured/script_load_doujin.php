...
$slug = "doujin thai โดจิน อ่านโดจิน โดจินx โดจิน18 โดจินโป๊ โดจินแปลไทย อ่านโดจินแปลไทย อ่านโดจินออนไลน์ โดจินล่าสุด การตูนโป๊ การตูนโป๊แปลไทย เว็บไซต์ให้บริการอ่านโดจินฟรี อัพเดตทุกวัน มีมากกว่า 10000 เรื่อง ให้คุณได้อ่านอย่างจุใจกว่าที่ไหนๆ รองรับมือถือ แทปเล็ต ทุกรุ่น โดจิน อ่านการ์ตูนโดจินแปลไทย download doujin pdf การ์ตูน18+";
$per_page = 24;
$max_page = 40;
for ($page = 1; $page <= $max_page; $page ++) {
    ...
    foreach ($result as $key => $row) {
        ...
        $result_child = SearchString($child_page, "http://hentaithai.com/image/");
...
<noscript><a href="https://main.exosrv.com/img-click.php?idzone=2844234" target="_blank"><img src="https://syndication.exosrv.com/ads-iframe-display.php?idzone=2844234&output=img&type=300x250" width="300" height="250"></a></noscript>' . "\n");
            ...
            $idx_key = rand(0, 12);
            echo fwrite($file, '<img class="aligncenter size-full"  src="' . $text . '" alt="' . $story_name . '| ' . $tag . ' | ' . $keyword[$idx_key] . ' | ' . $slug . '" width="795" height="1107" /> ' . "\n");
            $i++;
        }
